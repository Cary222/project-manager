...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "layout.exitFullscreen": "Exit fullscreen (show site sidebar and header)",
    "layout.exitFullscreen.label": "Exit fullscreen",
    "layout.enterFullscreen": "Enter fullscreen (hide site sidebar and header)",
    "layout.enterFullscreen.label": "Fullscreen",
    ...
    "i18n.noRules": "No rule files found",
    "i18n.selectRule": "Select a rule to view its content",
    "i18n.rule": "rule",
    "i18n.rules": "rules",
