...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "layout.exitFullscreen": "退出全屏（显示网站侧边栏和顶栏）",
    "layout.exitFullscreen.label": "退出全屏",
    "layout.enterFullscreen": "进入全屏（隐藏网站侧边栏和顶栏）",
    "layout.enterFullscreen.label": "全屏",
    "system.prompt": "系统提示词",
    ...
    "i18n.searching": "搜索中…",
    "i18n.noSkills": "未找到技能",
    "i18n.noRules": "未找到规则文件",
    "i18n.selectRule": "选择规则查看内容",
    "i18n.rule": "条规则",
    "i18n.rules": "条规则",
