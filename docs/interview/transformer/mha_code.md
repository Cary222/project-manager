---
source: https://notes.kamacoder.com/llm/transformer/mha_code.html
category: transformer
scraped_at: 2026-08-14T07:53:49.828Z
---

# [\#](https://notes.kamacoder.com/llm/transformer/mha_code.html\#%E6%89%8B%E6%92%95multi-head-attention-%E4%BB%8E%E5%8D%95%E5%A4%B4%E6%89%A9%E5%B1%95%E5%88%B0%E5%A4%9A%E5%A4%B4) 手撕Multi-Head Attention：从单头扩展到多头

[![卡码笔记](https://file1.kamacoder.com/i/web/2025-08-14kamabij.jpg)\\
\\
公众号@卡码笔记原创\\
\\
2026-05-25·全文 2401 字\\
\\
...
## [\#](https://notes.kamacoder.com/llm/transformer/mha_code.html\#%E5%A4%9A%E5%A4%B4%E6%AF%94%E5%8D%95%E5%A4%B4%E5%A4%9A%E4%BA%86%E5%93%AA%E5%87%A0%E6%AD%A5) 多头比单头多了哪几步？
...
## [\#](https://notes.kamacoder.com/llm/transformer/mha_code.html\#%E7%AC%AC%E4%B8%80%E6%AD%A5-%E7%BA%BF%E6%80%A7%E5%B1%82%E6%98%A0%E5%B0%84-%E7%94%9F%E6%88%90-q%E3%80%81k%E3%80%81v) 第一步：线性层映射，生成 Q、K、V
...
## [\#](https://notes.kamacoder.com/llm/transformer/mha_code.html\#%E7%AC%AC%E4%BA%8C%E6%AD%A5-head-%E6%8B%86%E5%88%86-%E6%8A%8A-d-model-%E5%88%87%E6%88%90-h-%E4%BB%BD) 第二步：Head 拆分——把 d\_model 切成 h 份

这是多头和单头最关键的差异所在。

以 $d\_model=8、h=2 为例，每个头拿到为例，每个头拿到为例，每个头拿到d\_k = 8 ÷ 2 = 4$ 维：
...
## [\#](https://notes.kamacoder.com/llm/transformer/mha_code.html\#%E7%AC%AC%E4%B8%89%E6%AD%A5-%E6%AF%8F%E4%B8%AA%E5%A4%B4%E7%8B%AC%E7%AB%8B%E8%B7%91-attention) 第三步：每个头独立跑 Attention
...
## [\#](https://notes.kamacoder.com/llm/transformer/mha_code.html\#%E7%AC%AC%E5%9B%9B%E6%AD%A5-concat-%E6%8B%BC%E6%8E%A5-%E6%8A%8A%E5%A4%9A%E4%B8%AA%E5%A4%B4%E5%90%88%E5%B9%B6%E5%9B%9E%E6%9D%A5) 第四步：Concat 拼接——把多个头合并回来
...
## [\#](https://notes.kamacoder.com/llm/transformer/mha_code.html\#%E7%AC%AC%E4%BA%94%E6%AD%A5-%E8%BE%93%E5%87%BA%E6%8A%95%E5%BD%B1-w-o-%E8%AE%A9%E5%A4%9A%E4%B8%AA%E5%A4%B4-%E8%9E%8D%E5%90%88%E5%AF%B9%E8%AF%9D) 第五步：输出投影 W\_O——让多个头"融合对话"

拼接之后，还差最后一步：乘输出投影矩阵 WOW\_OWO​。
...
WOW\_OWO​ 做的事，就是让不同头的信息能够 **互相混合**，产生一个统一的表示，传给后续的 FFN 子层。

## [\#](https://notes.kamacoder.com/llm/transformer/mha_code.html\#%E5%AE%8C%E6%95%B4%E4%BB%A3%E7%A0%81-%E6%8A%8A%E4%BA%94%E6%AD%A5%E6%89%93%E5%8C%85%E6%88%90%E4%B8%80%E4%B8%AA%E5%87%BD%E6%95%B0) 完整代码：把五步打包成一个函数
...
## [\#](https://notes.kamacoder.com/llm/transformer/mha_code.html\#%E4%BA%94%E6%AD%A5%E6%B5%81%E7%A8%8B) 五步流程

| 步骤 | 操作 | 输入形状 | 输出形状 |
| --- | --- | --- | --- |
| ① 线性映射 | X 乘 WQ/WK/WVW\_Q / W\_K / W\_VWQ​/WK​/WV​ | (L,dmodel)(L, d\_model)(L,dm​odel) | (L,dmodel)(L, d\_model)(L,dm​odel) |
| ② Head 拆分 | reshape + transpose | $ (L, d\_model) $ | (h,L,dk)(h, L, d\_k)(h,L,dk​) |
| ③ 并行 Attention | 每个头独立跑完整 Attention | (L,dk)×h(L, d\_k) × h(L,dk​)×h | (L,dk)×h(L, d\_k) × h(L,dk​)×h |
| ④ Concat 拼接 | transpose + reshape | (h,L,dk)(h, L, d\_k)(h,L,dk​) | (L,dmodel)(L, d\_model)(L,dm​odel) |
| ⑤ 输出投影 | 乘 WOW\_OWO​ | (L,dmodel)L, d\_model)L,dm​odel) | (L,dmodel)(L, d\_model)(L,dm​odel) |

从头到尾，输入是 (L,dmodel)(L, d\_model)(L,dm​odel)，输出还是 (L,dmodel)(L, d\_model)(L,dm​odel)。中间经历了一次维度的"分家"再"合并"，但整体维度始终保持一致，这也是 Transformer 能一层层堆叠的基础。
