---
source: https://notes.kamacoder.com/llm/transformer/transformer_block_code.html
category: transformer
scraped_at: 2026-08-14T07:53:07.109Z
---

# [\#](https://notes.kamacoder.com/llm/transformer/transformer_block_code.html\#%E6%89%8B%E6%92%95transformer-block-%E6%8A%8Aattention%E3%80%81ffn%E3%80%81norm%E6%8B%BC%E8%B5%B7%E6%9D%A5) 手撕Transformer Block：把Attention、FFN、Norm拼起来
...
## [\#](https://notes.kamacoder.com/llm/transformer/transformer_block_code.html\#%E4%B8%80%E4%B8%AA-block-%E5%88%B0%E5%BA%95%E9%95%BF%E4%BB%80%E4%B9%88%E6%A0%B7) 一个 Block 到底长什么样？
...
x1=LayerNorm(x+MHA(x))x\_1 = \\text{LayerNorm}(x + \\text{MHA}(x))
x1​=LayerNorm(x+MHA(x))

x2=LayerNorm(x1+FFN(x1))x\_2 = \\text{LayerNorm}(x\_1 + \\text{FFN}(x\_1))
...
- d\_model 是每个 token 的向量维度，比如这里用 8 维演示
...
## [\#](https://notes.kamacoder.com/llm/transformer/transformer_block_code.html\#%E5%85%88%E5%86%99-layernorm-%E5%92%8C-ffn) 先写 LayerNorm 和 FFN
...
还是那句话： **中间怎么变都可以，但最后必须回到 d\_model。**

## [\#](https://notes.kamacoder.com/llm/transformer/transformer_block_code.html\#%E5%86%99-multi-head-attention) 写 Multi-Head Attention
...
## [\#](https://notes.kamacoder.com/llm/transformer/transformer_block_code.html\#%E5%AE%9A%E4%B9%89%E5%AE%8C%E6%95%B4-transformer-block) 定义完整 Transformer Block
...
## [\#](https://notes.kamacoder.com/llm/transformer/transformer_block_code.html\#%E8%B7%91%E9%80%9A%E4%B8%80%E4%B8%AA-toy-example) 跑通一个 toy example
...
## [\#](https://notes.kamacoder.com/llm/transformer/transformer_block_code.html\#%E6%80%BB%E7%BB%93) 总结
