---
source: https://notes.kamacoder.com/llm/intro/fable5_system_prompt_leak.html
category: intro
scraped_at: 2026-08-14T07:52:30.099Z
---

# [\#](https://notes.kamacoder.com/llm/intro/fable5_system_prompt_leak.html\#claude-fable-5%E8%A2%AB%E7%A0%B4%E8%A7%A3%E4%BA%86-12%E4%B8%87%E5%AD%97%E7%B3%BB%E7%BB%9F%E6%8F%90%E7%A4%BA%E8%AF%8D%E5%85%A8%E6%9B%9D%E5%85%89) Claude Fable 5被破解了？12万字系统提示词全曝光

[![卡码笔记](https://file1.kamacoder.com/i/web/2025-08-14kamabij.jpg)\\
\\
公众号@卡码笔记原创\\
\\
2026-06-15·全文 3691 字\\
\\
...
> 不少读者问我，如何才能用上Claude pro（opus 4.8，Fable），我在这里篇单独讲一下： [国内Claude充值会员的方法(opens new window)](https://notes.kamacoder.com/qita/0002.claudepay.html)

录友们好。

Anthropic 刚发了 [Claude Fable 5](https://notes.kamacoder.com/llm/news/claude-fable-5.html)，号称目前最强的公开模型。
...
## [\#](https://notes.kamacoder.com/llm/intro/fable5_system_prompt_leak.html\#%E4%B8%80%E3%80%81%E5%85%88%E6%8A%8A%E8%BE%B9%E7%95%8C%E5%88%92%E6%B8%85%E6%A5%9A-%E5%88%AB%E8%A2%AB%E6%A0%87%E9%A2%98%E5%B8%A6%E5%81%8F) 一、先把边界划清楚：别被标题带偏
...
## [\#](https://notes.kamacoder.com/llm/intro/fable5_system_prompt_leak.html\#%E4%BA%8C%E3%80%81%E7%B3%BB%E7%BB%9F%E6%8F%90%E7%A4%BA%E8%AF%8D%E5%88%B0%E5%BA%95%E6%98%AF%E4%BB%80%E4%B9%88) 二、系统提示词到底是什么
...
## [\#](https://notes.kamacoder.com/llm/intro/fable5_system_prompt_leak.html\#%E4%B8%89%E3%80%8112%E4%B8%87%E5%AD%97%E9%87%8C%E5%88%B0%E5%BA%95%E8%A3%85%E4%BA%86%E4%BB%80%E4%B9%88) 三、12万字里到底装了什么
...
## [\#](https://notes.kamacoder.com/llm/intro/fable5_system_prompt_leak.html\#%E5%9B%9B%E3%80%81%E4%B8%BA%E4%BB%80%E4%B9%88%E9%9D%9E%E5%BE%97%E5%86%99%E8%BF%99%E4%B9%88%E9%95%BF) 四、为什么非得写这么长
...
## [\#](https://notes.kamacoder.com/llm/intro/fable5_system_prompt_leak.html\#%E4%BA%94%E3%80%81%E5%85%B3%E9%94%AE%E7%9A%84%E8%B4%A6-3%E4%B8%87token-%E4%BD%A0%E8%BF%98%E6%B2%A1%E5%BC%80%E5%8F%A3%E5%B0%B1%E8%8A%B1%E6%8E%89%E4%BA%86) 五、关键的账：3万token，你还没开口就花掉了
...
其中上下文窗口这笔账，我们在之前聊 [上下文窗口](https://notes.kamacoder.com/interview/llm/claude_code_context_window_interview.html) 的时候也强调过： **窗口是预算，不是仓库。** 任何固定占用，都是从你和模型的有效对话空间里扣的。

3 万 token 的固定开销，听起来很奢侈。

那大厂为什么还敢这么写？

## [\#](https://notes.kamacoder.com/llm/intro/fable5_system_prompt_leak.html\#%E5%85%AD%E3%80%81%E5%A4%A7%E5%8E%82%E7%9A%84%E5%BA%95%E6%B0%94-prompt-cache-%E5%85%9C%E5%BA%95) 六、大厂的底气：Prompt Cache 兜底
...
这也是为什么 Claude Code 这类产品，会把 Prompt Cache 当成核心架构约束——这部分我专门写过一篇 [Claude Code 为什么快](https://notes.kamacoder.com/llm/intro/claude_prompt_cache.html)，里面讲了前缀匹配、工具定义稳定性这些细节，感兴趣的录友可以接着看。

一句话总结大厂的算盘：

**用一段固定的长提示词换来稳定的能力和安全，再用缓存把这段长提示词的成本摊薄到可以接受。**

## [\#](https://notes.kamacoder.com/llm/intro/fable5_system_prompt_leak.html\#%E4%B8%83%E3%80%81%E6%99%AE%E9%80%9A%E5%BC%80%E5%8F%91%E8%80%85%E8%83%BD%E6%8A%84%E4%BB%80%E4%B9%88%E4%BD%9C%E4%B8%9A) 七、普通开发者能抄什么作业
...
**写 prompt、写 [CLAUDE.md](https://notes.kamacoder.com/llm/intro/claude_md.html)，要追求的是"稳定的结构"，不是"华丽的长度"。**
...
## [\#](https://notes.kamacoder.com/llm/intro/fable5_system_prompt_leak.html\#%E5%85%AB%E3%80%81%E9%A1%BA%E4%BE%BF%E8%AF%B4%E8%AF%B4-%E7%A0%B4%E8%A7%A3-%E6%98%AF%E6%80%8E%E4%B9%88%E5%81%9A%E5%88%B0%E7%9A%84) 八、顺便说说："破解"是怎么做到的
...
## [\#](https://notes.kamacoder.com/llm/intro/fable5_system_prompt_leak.html\#%E4%B9%9D%E3%80%81%E5%86%99%E5%9C%A8%E6%9C%80%E5%90%8E) 九、写在最后
...
←
[AI编程产品的三层架构](https://notes.kamacoder.com/llm/intro/ai-coding-three-layers.html)[大模型应用开发、算法岗、开发岗什么区别](https://notes.kamacoder.com/llm/intro/application_development.html)
→
