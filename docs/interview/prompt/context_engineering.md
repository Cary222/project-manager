---
source: https://notes.kamacoder.com/llm/app/context_engineering.html
category: prompt
scraped_at: 2026-08-14T07:58:30.800Z
---

# [\#](https://notes.kamacoder.com/llm/app/context_engineering.html\#%E4%B8%8A%E4%B8%8B%E6%96%87%E7%AA%97%E5%8F%A3%E6%9C%89%E5%A4%9A%E5%A4%A7-context-engineering%E5%85%A5%E9%97%A8) 上下文窗口有多大？Context Engineering入门

[![卡码笔记](https://file1.kamacoder.com/i/web/2025-08-14kamabij.jpg)\\
\\
公众号@卡码笔记原创\\
\\
2026-07-30·全文 4021 字\\
\\
...
上一篇 [《大模型结构化输出》](https://notes.kamacoder.com/llm/app/structured_output.html) 讲的是怎么管住模型的输出：用JSON Schema定义结构，用校验和重试接住异常。
...
## [\#](https://notes.kamacoder.com/llm/app/context_engineering.html\#%E7%AE%80%E8%A6%81%E5%9B%9E%E7%AD%94) 简要回答
...
## [\#](https://notes.kamacoder.com/llm/app/context_engineering.html\#%E8%AF%A6%E7%BB%86%E5%9B%9E%E7%AD%94) 详细回答

### [\#](https://notes.kamacoder.com/llm/app/context_engineering.html\#%E4%B8%8A%E4%B8%8B%E6%96%87%E7%AA%97%E5%8F%A3%E4%B8%8D%E6%98%AF%E8%BE%93%E5%85%A5%E6%A1%86%E5%A4%A7%E5%B0%8F-%E6%98%AF%E4%B8%80%E6%95%B4%E7%AC%94token%E9%A2%84%E7%AE%97) 上下文窗口不是输入框大小，是一整笔Token预算
...
### [\#](https://notes.kamacoder.com/llm/app/context_engineering.html\#_200k%E3%80%811m%E5%88%B0%E5%BA%95%E6%9C%89%E5%A4%9A%E5%A4%A7) 200K、1M到底有多大？
...
- [OpenAI模型列表(opens new window)](https://developers.openai.com/api/docs/models)
- [Claude上下文窗口说明(opens new window)](https://platform.claude.com/docs/en/build-with-claude/context-windows)
- [Gemini长上下文说明(opens new window)](https://ai.google.dev/gemini-api/docs/long-context)
...
### [\#](https://notes.kamacoder.com/llm/app/context_engineering.html\#%E4%B8%BA%E4%BB%80%E4%B9%88%E4%BF%A1%E6%81%AF%E8%B6%8A%E5%A4%9A-%E6%A8%A1%E5%9E%8B%E5%8F%8D%E8%80%8C%E5%8F%AF%E8%83%BD%E7%AD%94%E5%BE%97%E6%9B%B4%E5%B7%AE) 为什么信息越多，模型反而可能答得更差？
...
研究里有一个很典型的现象叫 [Lost in the Middle(opens new window)](https://direct.mit.edu/tacl/article/doi/10.1162/tacl_a_00638/119630/Lost-in-the-Middle-How-Language-Models-Use-Long)：同样的关键信息，只改变它在长上下文中的位置，模型表现就可能明显变化；信息放在开头或结尾时往往更容易被利用，埋在中间时更容易丢失。
...
### [\#](https://notes.kamacoder.com/llm/app/context_engineering.html\#context-engineering%E5%92%8Cprompt-engineering%E6%9C%89%E4%BB%80%E4%B9%88%E5%8C%BA%E5%88%AB) Context Engineering和Prompt Engineering有什么区别？

[《Prompt Engineering不是“写提示词”》](https://notes.kamacoder.com/llm/app/prompt_engineering.html) 里，我们强调了角色、任务、约束和输出格式； [《Few-shot、CoT与自我反思》](https://notes.kamacoder.com/llm/app/prompt_fewshot_cot_reflection.html) 又讲了怎么用示例、推理步骤和复核机制改变生成过程。它们都属于Prompt Engineering，重点是 **怎么表达指令、怎么引导生成**。
...
[Anthropic关于Context Engineering的文章(opens new window)](https://www.anthropic.com/engineering/effective-context-engineering-for-ai-agents) 给了一个很实用的定义：在模型推理时，持续策划和维护一组最优Token。换成大白话就是： **用尽可能少的高信号信息，让模型更可能做对当前任务。**

### [\#](https://notes.kamacoder.com/llm/app/context_engineering.html\#%E4%B8%80%E6%AC%A1%E4%B8%8A%E4%B8%8B%E6%96%87%E7%BC%96%E6%8E%92-%E5%88%B0%E5%BA%95%E5%81%9A%E4%BA%86%E4%BB%80%E4%B9%88) 一次上下文编排，到底做了什么？
...
### [\#](https://notes.kamacoder.com/llm/app/context_engineering.html\#%E6%BB%91%E5%8A%A8%E7%AA%97%E5%8F%A3-%E5%8F%AA%E4%BF%9D%E7%95%99%E6%9C%80%E8%BF%91%E5%87%A0%E8%BD%AE-%E5%A4%9F%E4%B8%8D%E5%A4%9F) 滑动窗口：只保留最近几轮，够不够？
...
### [\#](https://notes.kamacoder.com/llm/app/context_engineering.html\#%E6%91%98%E8%A6%81%E5%8E%8B%E7%BC%A9%E4%B8%8D%E6%98%AF-%E6%8A%8A%E5%89%8D%E6%96%87%E7%BC%A9%E7%9F%AD%E4%B8%80%E7%82%B9) 摘要压缩不是“把前文缩短一点”
...
### [\#](https://notes.kamacoder.com/llm/app/context_engineering.html\#%E9%95%BF%E5%AF%B9%E8%AF%9D%E6%80%8E%E4%B9%88%E8%B7%91%E4%B8%8B%E5%8E%BB-%E9%9D%A0%E7%9A%84%E6%98%AF%E5%88%86%E5%B1%82%E8%AE%B0%E5%BF%86) 长对话怎么跑下去？靠的是分层记忆
...
这才是“记忆管理”。 **不是让模型永远背着全部历史，而是让信息在合适的时候重新进入工作上下文。** 关于短期记忆、长期记忆和RAG的边界，可以接着看 [《Agent的记忆》](https://notes.kamacoder.com/llm/app/agent_memory.html)。

### [\#](https://notes.kamacoder.com/llm/app/context_engineering.html\#%E5%B7%A5%E5%85%B7%E8%B0%83%E7%94%A8%E4%B8%BA%E4%BB%80%E4%B9%88%E7%89%B9%E5%88%AB%E5%AE%B9%E6%98%93%E6%B1%A1%E6%9F%93%E4%B8%8A%E4%B8%8B%E6%96%87) 工具调用为什么特别容易污染上下文？
...
缓存也救不了这个问题。Prompt Cache可以降低重复输入的计算或费用，但缓存里的Token通常仍占上下文窗口。 **便宜地塞满，还是塞满。** 这部分的计算和缓存复用过程，可以看 [《Claude Code为什么快？Prompt Cache一篇讲明白》](https://notes.kamacoder.com/llm/claude/claude_prompt_cache.html)。

### [\#](https://notes.kamacoder.com/llm/app/context_engineering.html\#%E6%80%8E%E4%B9%88%E5%88%A4%E6%96%AD%E4%B8%8A%E4%B8%8B%E6%96%87%E5%B7%A5%E7%A8%8B%E5%81%9A%E5%BE%97%E5%A5%BD%E4%B8%8D%E5%A5%BD) 怎么判断上下文工程做得好不好？
...
## [\#](https://notes.kamacoder.com/llm/app/context_engineering.html\#%E7%9F%A5%E8%AF%86%E6%8B%93%E5%B1%95) 知识拓展
...
[RAG](https://notes.kamacoder.com/llm/app/chain_of_rag.html) 是上下文工程的一种重要手段，负责从外部知识库找相关材料。但Context Engineering还要管理系统规则、消息历史、工具定义、工具结果、任务状态、排序、压缩和预算。 **RAG解决“找什么”，上下文工程还要解决“怎么放、放多少、什么时候更新”。**
...
←
[结构化输出：JSON Schema怎么约束](https://notes.kamacoder.com/llm/app/structured_output.html)[同步、异步、流式输出怎么选](https://notes.kamacoder.com/llm/app/streaming_output.html)
→
