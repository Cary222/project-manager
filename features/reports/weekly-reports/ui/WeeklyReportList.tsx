  ...
  if (reports.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-ink-300 bg-white p-12 text-center">
        ...
        <p className="mt-1 text-sm text-ink-500">开始记录你的第一周工作吧</p>
        <Link
          ...
          <div className="flex items-start justify-between gap-3">
            ...
            <div className="flex shrink-0 items-center gap-2">
              ...
              <button
                ...
                className="rounded-lg px-3 py-1.5 text-sm text-ink-500 transition hover:bg-ink-100 hover:text-red-700 disabled:opacity-50"
              >
