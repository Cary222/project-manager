...
import { SettingsPanel, SettingsSectionIcon, type ExtendedSettingsSection } from "./SettingsPanel";
...
function buildSessionUrl(sessionId: string | null): string {
  ...
  return qs ? `${typeof window !== "undefined" ? window.location.pathname : "/ai-workspace"}?${qs}` : (typeof window !== "undefined" ? window.location.pathname : "/ai-workspace");
}
...
export function AppShell() {
  ...
  const [settingsSection, setSettingsSection] = useState<ExtendedSettingsSection | null>(null);
