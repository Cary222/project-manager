...
function AppShellContent() {
    ...
    (projectKey: string) => {
      ...
      void fetch("/api/sessions")
        .then((r) => {
          ...
          return r.ok
            ? (r.json() as Promise<{ sessions: SessionInfo[] }>)
            : null;
        })
        .then((d) => {
  ...
  const effectiveNewSessionCwd =
    newSessionCwd ??
    selectedSession?.cwd ??
    (selectedSession === null && activeCwd ? activeCwd : null);
      ...
      <div style={{ display: "flex", alignItems: "stretch", height: "100%" }}>
        ...
        {(() => {
          ...
          const buttonLabel = translate(
            embedded
              ? "layout.enterFullscreen.label"
              : "layout.exitFullscreen.label",
          );
          return (
            <button
              type="button"
              ...
              title={translate(
                embedded ? "layout.enterFullscreen" : "layout.exitFullscreen",
              )}
              ...
              data-mobile-toolbar-action={
                mobile ? "fullscreen-toggle" : undefined
              }
            >
              {embedded ? (
                <svg
          ...
          <>
            ...
            {costText && (
              <span
                ...
                style={{ color: "var(--text)", fontWeight: 500, flexShrink: 1 }}
              >
                {costText}
              </span>
            )}
  ...
  return (
    ...
    `}</style>
      ...
      {rulesConfigOpen && (
        <RulesConfig
          cwd={projectTrustCwd ?? ""}
          onClose={() => setRulesConfigOpen(false)}
        />
      )}
    </>
  );
