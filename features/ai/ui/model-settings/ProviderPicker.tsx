...
/**
 * Shared Model Settings — Provider Picker（KEEP）
 *
 * 从 ModelsConfig.tsx 的 AddProviderPicker 提取：搜索 / 分类
 * （Custom / OAuth 订阅 / API Key）/ 40+ provider 卡片。
 * OAuth 列表为空时仅显示 Custom + API Key 分区（ProjectHub 场景）。
 */
