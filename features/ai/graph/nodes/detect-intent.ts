...
const SEARCH_KEYWORDS: { pattern: RegExp; category: string }[] = [
  ...
  // 人员近况 / 工作活动查询
  {
    pattern: /(?:最近|近期|这周|本周|近来|今天|昨天|前天|上周|前天|这阵子|近几天|前几天).{0,12}(?:在做什么|在干什么|在干嘛|做了什么|干了什么|在做什么|做什么|干什么|开发什么|工作近况|工作内容|进展|动态|干了啥|工作时间)/i,
    category: "user_activity",
  },
  {
    pattern: /(?:在做什么|在干什么|在干嘛|做了什么|干了什么|做什么|干什么|开发什么|工作近况|工作内容|工作时间|进展|动态).{0,12}(?:最近|近期|这周|本周|近来|今天|昨天|前天|上周|这阵子|近几天)/i,
    category: "user_activity",
  },
  {
    // “cary 干了什么” 这类极简问法：人名 + 干了什么 / 进展
    pattern: /[\u4e00-\u9fa5A-Za-z0-9_.\-@]{1,30}\s*(?:干了什么|做了啥|做了什么|进展|进度|最近动态)/i,
    category: "user_activity",
  },
  // 内容/文档/需求类 — 隐含检索意图
  {
